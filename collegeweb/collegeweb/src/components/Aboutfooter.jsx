            ...
            <div className="text-black">
              <div className="flex flex-col text-white justify-center items-center ">
                <iframe
                  ...
                  className="border-0 w-[55vh] h-[33vh] pb-2"
                  allowFullScreen=""
                  loading="lazy"
                  referrerPolicy="no-referrer-when-downgrade"
                ></iframe>
                <address className="flex flex-col items-center">
                  <h1>SHREE S.L. JANGU INSTITUTE OF VETERINARY SCIENCE,</h1>
                  <p>
                    JODHPUR, 427, Pal Link Rd, Masuria Colony, Baldev Nagar,
                  </p>
                  <p>Jodhpur, Rajasthan 342008</p>
                </address>
                <div className="flex flex-col justify-center items-center mt-4">
                  <img
                    ...
                    alt=""
                  />
                  <p className="pt-2"> Kartik Sharm</p>
