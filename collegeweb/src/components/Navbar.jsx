        ...
        <div className="flex  ">
          ...
          <ul className="absolute top-1/2 left-3/4  transform -translate-x-1/2 -translate-y-1/2 hidden xl:flex lg:w-auto lg:space-x-12 pr-4">
            <li className="group relative">
              {token && role === "user" && (
                <Link
                  className="text-xl text-gray-100 hover:text-orange-300 font-medium flex"
                  to="/pay"
                >
            ...
            <ul className="mb-2">
              ...
              <li>
                {token && role === "user" && (
                  <Link
                    to="/pay"
                    className="flex items-center py-4 px-5 text-lg text-gray-100  hover:text-orange-900 hover:bg-orange-50 rounded-lg "
                  >
              ...
              <li>
                {token && role === "user" && (
                  <Link
                    className="flex items-center text-lg py-4 px-5 text-gray-100  hover:text-orange-900 hover:bg-orange-50 rounded-lg"
                    to="/transaction"
                  >
